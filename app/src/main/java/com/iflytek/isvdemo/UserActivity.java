...
public class UserActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.btn_confirm).setOnClickListener(UserActivity.this);
		mToast = Toast.makeText(UserActivity.this, "", Toast.LENGTH_SHORT);
	}
	...
	public void onClick(View v) {
		...
		case R.id.btn_confirm:
			...
			Intent intent = new Intent(UserActivity.this, IsvDemo.class);
